...
load(file = file.path(MSE.dir,"Results",runName,paste0(OM,"_HCR",HCR,"_SimpSIM_Workspace.Rdata")))
...
#quick look at first year stock weights  
#FLCore::stock.wt(Stocks[['0.001']])[,'2017',,,,]
...
save(out, file = file.path(MSE.Dir,"Results",runName,paste0(OM,"_HCR",HCR,"_SimpSIM_STATS.Rdata")))
